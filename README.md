...
Chromium поставляется отдельным Flatpak-дополнением из того же репозитория:
Flatpak устанавливает и обновляет его вместе с Bastle. Приложение никогда не
меняет движок без подтверждения; профили, cookies и авторизованные сессии
движков не смешиваются.
